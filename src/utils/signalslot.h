...
namespace tstudio
{
   ...
   *        classes
   *
   * The classes ::tstudio::Signal and ::tstudio::Slot are similar to Qt's
   ...
   * @tparam Args     Arguments passed from ::tstudio::Signal::notify() to the
   *                  callbacks
   */
  template <typename Tsender, typename... Args>
  class Signal
   ...
   *        classes
   *
   * Instances of this class allow to connect ::tstudio::Signal objects to
